...
const customerSchema = z.object({
  ...
  billingAddresses: z.array(z.object({
    id: z.string(),
    label: z.string(),
    address: z.string(),
    stateCode: z.string().optional().nullable(),
    ...
    const result = await db.$transaction(async (tx) => {
      const newCustomer = await tx.customer.create({
        data: {
          ...
          billingAddresses: validated.billingAddresses ? JSON.parse(JSON.stringify(validated.billingAddresses)) : null,
          shippingAddresses: validated.shippingAddresses ? JSON.parse(JSON.stringify(validated.shippingAddresses)) : null,
