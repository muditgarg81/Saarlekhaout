...
export default async function OrdersPage() {
  ...
  const [orders, customers, items, termsTemplates, docSettings, company] = await Promise.all([
    ...
    db.item.findMany({
      ...
      select: { id: true, code: true, name: true, baseUom: true, altUom: true, gstRate: true, specification: true },
      orderBy: { name: "asc" },
      take: 1000,
    }),
