...
export default function QuotationsList({
  ...
  const addLine = () => setLines([...lines, { itemId: "", uom: "", qty: 1, rate: 0, discount: 0, gstRate: 18, specification: "" }]);
  ...
  const onItemPick = (i: number, itemId: string) => {
    ...
    setLine(i, { itemId, uom: lines[i]?.uom || "", gstRate: it?.gstRate ?? 18, specification: it?.specification || "" });
  };
