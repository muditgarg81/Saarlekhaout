  ...
  if (!docSettings) {
    docSettings = await db.companyDocumentSettings.create({
      data: {
        ...
        poHeaderNote: "Thank you for choosing us.",
        poFooterNote: "Subject to local jurisdiction.",
        authorizedSignatory: "Sales Manager",
        declaration: "We declare that this document shows the actual price of the goods described and that all particulars are true and correct.",
      },
    });
  }
